...
from msf import RandomMSF
from inferential_theory import RandomInferentialTheoryGenerator
from inquiry import InquiryFor, InquiryFromStage
from stage import ManualNextStageInfer
...
class UserInterface():
    ...
    def run(self) -> None:
        ...
        msf = RandomMSF(language = self.lang)
